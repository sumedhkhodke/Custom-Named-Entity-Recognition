...
from utilities import trim_entity_spans, convert_parse, ResumeDataset, tag2idx, idx2tag, get_hyperparameters, train_and_val_model
...
data = trim_entity_spans(convert_parse('data/Resumes.json'))
